...
# Prompt for Cloudflare certificate files
echo "You need your Cloudflare Origin Certificate and Private Key."
echo "Please have these files ready to paste into the editor."
...
mysql -e "CREATE DATABASE roundcube DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;"
